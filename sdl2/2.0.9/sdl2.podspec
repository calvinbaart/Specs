Pod::Spec.new do |spec|
  ...
  spec.description = "sed -i -E 's|exit_status =|//exit_status =|g' SDL2-2.0.9/src/video/uikit/SDL_uikitappdelegate.m;"
  spec.license = {:type => 'ZLIB', :file => 'COPYING.txt'}
  spec.module_name = 'SDL2'
  spec.authors = {'Sam Lantinga' => 'slouken@libsdl.org'}
  spec.source = {:http => 'https://www.libsdl.org/release/SDL2-2.0.9.zip'}
  ...
  spec.prepare_command = 'mv SDL2-2.0.9/* .'
  spec.source_files = 'src/thread/generic/SDL_syssem.c', 'include/*.h', 'src/**/*.{c,h,m}'
  spec.exclude_files = 'include/SDL_test*', 'include/SDL_config_android.h', 'include/SDL_config_minimal.h', 'include/SDL_config_pandora.h', 'include/SDL_config_psp.h', 'include/SDL_config_windows.h', 'include/SDL_config_winrt.h', 'include/SDL_config_wiz.h', 'include/SDL_alsa_audio.h', 'src/hidapi/libusb/**/*', 'src/hidapi/testgui/**/*', 'src/thread/pthread/SDL_syssem.c', 'src/thread/generic/SDL_syscond.c', 'src/thread/generic/SDL_sysmutex.c', 'src/thread/generic/SDL_systhread.c', 'src/thread/generic/SDL_systls.c', 'src/**/android/*', 'src/**/haiku/*', 'src/**/linux/*', 'src/**/nacl/*', 'src/**/pandora/*', 'src/**/raspberry/*', 'src/**/vivante/*', 'src/**/windows/*', 'src/**/psp/*', 'src/**/wayland/*', 'src/**/x11/*', 'src/**/emscripten/*', 'src/**/winrt/*', 'src/**/direct3d/*', 'src/**/direct3d11/*', 'src/**/directfb/*', 'src/**/mir/*', 'src/**/alsa/*', 'src/**/arts/*', 'src/**/bsd/*', 'src/**/directsound/*', 'src/**/dsp/*', 'src/**/esd/*', 'src/**/fusionsound/*', 'src/**/nas/*', 'src/**/paudio/*', 'src/**/qsa/*', 'src/**/pulseaudio/*', 'src/**/sndio/*', 'src/**/sun/*', 'src/**/winmm/*', 'src/**/xaudio2/*', 'src/**/qnx/*', 'src/**/egl/*', 'src/main/dummy/SDL_dummy_main.c', 'src/test/*'
  ...
  spec.osx.exclude_files = 'include/SDL_config_iphoneos.h', 'src/**/uikit/*', 'src/**/iphoneos/*', 'src/**/ios/*', 'src/**/opengles2/*'

  spec.ios.private_header_files = 'src/video/uikit/SDL_*.h'
  spec.osx.private_header_files = 'src/video/cocoa/SDL_*.h'

  spec.xcconfig = {}
  spec.compiler_flags = '-I${PODS_ROOT}/src/libm -DSDL_VIDEO_OPENGL_EGL=0 -DSDL_VIDEO_RENDER_OGL_ES2=0 -DSDL_VIDEO_RENDER_OGL_ES=0'
